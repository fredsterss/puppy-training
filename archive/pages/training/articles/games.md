---
title: "Games to Play (and Not Play) With Your Puppy"
source_url: "https://www.yourpurebredpuppy.com/training/articles/games.html"
wayback_url: "https://web.archive.org/web/20230506062347id_/https://www.yourpurebredpuppy.com/training/articles/games.html"
resolved_wayback_url: "https://web.archive.org/web/20230506062432id_/https://www.yourpurebredpuppy.com/training/articles/games.html"
capture_timestamp: "20230506062432"
fetched_at: "2026-08-10T13:29:35+00:00"
---
...
Here's an example of how difficult retrieving is for many dogs. In obedience competition, many dogs succeed at the novice level. But far fewer succeed at the intermediate and advanced levels. Why? Because at the higher levels, dogs must retrieve. That single requirement knocks out a whole lotta dogs!
...
If you're hoping to compete with your dog in a sport that requires retrieving, or if you simply want a dog who will retrieve reliably, the game needs to become a command. There are several good systematic methods for teaching a reliable retrieve, but those methods are long and involved and beyond the scope of this article.
...
I've been playing Tug with my own dogs for decades. When played properly, Tug can be a satisfying, one-on-one bonding time between leader and follower. But I have been more cautious about recommending the game to other owners because it's so easy to play it improperly.
...
For larger dogs, you might want a more durable commercial toy. Leerburg Online sells great Tug toys such as this [lightweight puppy tug](https://leerburg.com/thinpuppytug-synthetic.htm).
...
When you bring out the Tug toy, show it to your dog and name it: "Tug. Tug tug. Play Tug?" Keep your voice upbeat and encouraging. Appeal to your dog's prey instinct by twitching the Tug along the ground like an agile, quick-moving prey animal, say a chipmunk.

First the Tug is still. Then it does a quick, jerky little movement. Then it freezes again. Then suddenly leaps to one side. Make it interesting!
...
Who should win games of Tug? Your dog! You want him to view you as a source of fun, not a kill-joy who keeps confiscating the glorious toy.
...
Although you're letting your pup "win" the game, there is an essential rule that you must teach him.

**He must release the toy when told to.**

After the dog has had a minute to parade around with his prize, it's time to get the toy back. He must release it so YOU can decide whether to start another round or end the game.
...
Get hold of his dragging leash and bring him close to you. Take hold of the toy and say "Give" or "Drop" or whatever your let-go word is (taught in my training books).

Your puppy might be reluctant to part with such a wonderful toy. He might even think that since you've put your hand back on the toy, you're starting up the game again. This is natural for a beginner dog to think, so if he starts to tug at the toy again, don't get mad! You don't want to dim his enthusiasm.
...
But if he absolutely won't let go even when you're holding the toy very still, open his mouth so that he must release the toy. You learned two ways to open your dog's mouth in my training book.
...
However... growling can also be a sign of anxiety. When a dog becomes a little anxious, he might growl in a blustery attempt to convince you that he's one tough dude who should not be messed with!

You can relieve his anxiety by lowering the intensity of the game. Pull less forcefully. If he stops vocalizing, you can try slowly building back up again to find out what works best for him.

Now, if he's growling because he refuses to give up the toy so that you must open his mouth to remove it, that's an entirely different kettle of fish. Deliver a sharp "AH-ah" and end that play session.
...
For example, attach the tug toy to a 2- or 3-foot cord, then hold the end of the cord instead of the toy itself. Now manipulate the cord to make the toy bounce around in a (hopefully) enticing way, and your pup just might pounce on it. Over time, you can gradually work your hands along the cord, closer and closer to the toy.
...
You can buy obstacles online from [affordableagility.com](https://www.affordableagility.com) (still a bit expensive, just less so than most other agility sources). Or if you're handy, you can make a few simple obstacles yourself. Just be careful that they're very sturdy!
...
The Pause Table is extremely easy to teach if your dog already knows "Go to your bed" or "Go place" (both taught in my training books).
