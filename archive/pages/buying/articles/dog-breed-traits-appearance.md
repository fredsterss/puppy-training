---
title: "Choosing a Dog Breed Based on its Appearance"
source_url: "https://www.yourpurebredpuppy.com/buying/articles/dog-breed-traits-appearance.html"
wayback_url: "https://web.archive.org/web/20230506062347id_/https://www.yourpurebredpuppy.com/buying/articles/dog-breed-traits-appearance.html"
resolved_wayback_url: "https://web.archive.org/web/20230506062445id_/https://www.yourpurebredpuppy.com/buying/articles/dog-breed-traits-appearance.html"
capture_timestamp: "20230506062445"
fetched_at: "2026-08-10T13:13:39+00:00"
---
...
1. **[Size](https://www.yourpurebredpuppy.com/buying/articles/dog-breed-traits-size.html)** is important because different size dogs require that you provide a different kind of home and yard, space and exercise, and safety.
2. **Coat** is important because you must be able to provide the amount of [brushing and trimming](https://www.yourpurebredpuppy.com/buying/articles/dog-breed-traits-grooming.html) required by that coat, and you must be able to handle whatever amount of [shedding](https://www.yourpurebredpuppy.com/buying/articles/dog-breed-traits-shedding.html) is produced by that coat. Too many dogs are surrendered to shelters for "shedding too much" or "aggravating my allergies." You don't want to be that kind of owner.
...
- Your husband might love muscular dogs with massive heads.
- Your best friend might prefer wolfish dogs with prick ears and a curled tail.

As personal preferences, they're all perfectly valid. But in this article, I want to explain how some preferences come with health consequences that you might not have been aware of.
...
Right. Not just Saint Bernards, but Newfoundlands, Basset Hounds, Mastiffs, Bernese Mountain Dogs, Bulldogs, etc.
...
Essentially – for no apparent reason – the stomach fills up with food, air, and gas, and keeps expanding, becoming hard and bloated. This is the *dilation* phase of G**D**V.

If the dog is immediately rushed to the emergency room, the vet might be able to relieve the pressure in time.

Otherwise, the swollen stomach will likely twist and/or flip over, taking the spleen and pancreas along with it – this is the life-threatening *volvulus* phase of GD**V**. Blood flow to the digestive organs is now blocked, resulting in rapid tissue death that cascades into other organs such as the heart. Death occurs quickly.
...
The most likely breed to bloat is the **Great Dane,** with nearly 1 out of every 2 Danes suffering an attack. It is the leading cause of death in this breed.
...
- Plenty of NON-docked breeds (like English Pointers, English Setters, Dachshunds) hunt just fine.
...
Other western countries are way ahead of Americans in this regard. Across most of Europe, Australia, and New Zealand, docking has been declared unnecessary and inhumane, and docking has been banned (or heavily restricted).
...
To communicate. High tail, low tail, stiff tail, quivering tail, wagging tail, tail between legs... tail positions say important things. Removing half his tail impairs a dog's abillity to communicate his mood and intentions to other dogs. Friendly? dominant? submissive? worried? Misunderstandings increase the risk of fights.
...
Cropped ears. These ears start out hanging and would stay that way except that at 6-12 weeks, a veterinarian cuts the ears into a sharp pointy shape, then bandages them into an upright position to "train" the cut ears to stand erect.

That isn't the end, either. The multiple-week recovery period is very uncomfortable as the puppy endures sore ears, repeated bandaging, and itchy tape pulling at his skin. Often the owner isn't satisfied with the length or position of the cropped ears, so a second surgery will be necessary. Or, after months of persistent taping... the ears never do stand up straight. All that risk and pain for nothing.
...
Dogs are cropped for tradition and appearance. Cropped ears give the dog a more alert (and more intimidating, even fierce) expression, and our eye has become accustomed to that appearance.
...
Puppy buyers often find themselves drawn to a breeder's marketing shtick of "Rare colors!"
...
Also wanted to mention a study done by an Australian university showed that in Labs, at least, chocolate is linked to a greater likelihood of skin conditions and a shorter lifespan. It is unknown whether this is true of brown dogs in other breeds.

Finally, in my own personal experience with Labs and Poodles, I've found a lot of chocolate individuals to be more impulsive/clownish compared to other Lab and Poodle colors.

BRINDLE

Brindle isn't actually a color, but a distinctive marking best described as tiger stripes.

Essentially a brindle dog has a base color (from light fawn to deep red) with darker (usually black) stripes on top.
...
- Pay attention to the parents.  If neither of the pup's parents is blue, or if only one parent is blue (and has a healthy coat), a blue puppy is less likely to have inherited the disease. If both  parents are blue... well, responsible breeders would not breed blue-to-blue.
...
Unfortunately, that whitening effect is not limited to body  hair. There are also tiny hairs inside a dog's ears,  and these must be *pigmented* (some darker color) in order for the nerve endings to conduct auditory impulses (sound). If this pigment whitens too much, the nerve endings atrophy, resulting in partial or total hearing loss.
...
However, like the merle gene, the piebald  gene can cause congenital deafness if a pup inherits it from EACH parent.
