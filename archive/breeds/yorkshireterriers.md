---
title: "Yorkshire Terriers (Yorkies)"
breed_slug: "yorkshireterriers"
component_count: 4
unique_content_sections: 3
generated_at: "2026-08-10T13:35:58+00:00"
source_urls:
  - "https://www.yourpurebredpuppy.com/reviews/yorkshireterriers.html"
  - "https://www.yourpurebredpuppy.com/dog-breeds/yorkshire-terrier.html"
  - "https://www.yourpurebredpuppy.com/training/yorkshireterriers.html"
  - "https://www.yourpurebredpuppy.com/health/yorkshireterriers.html"
---
...
|  |  |
| --- | --- |
| [Temperament](#temperament) | Bright, lively, inquisitive, spunky, sharp shrill bark, can be an excitable chaser but also likes to snuggle |
| [Pros and Cons](#pros-cons) | What's good... What's bad... |
| [Size](#size) | Tiny (7-8 inches, 3-7 lbs, but some are larger) |
| ["Types"](#types) | Show lines, so-called "teacup" lines |
| [Exercise](#exercise) | Minimal |
| [Training](#training) | Mostly moderate, but housebreaking very difficult |
| [With strangers](#strangers) | Can be friendly, but more often reserved, sometimes suspicious |
| [With children](#children) | Older well-behaved children only |
| [With other pets](#otherpets) | Fine with family pets, but often feisty toward strange dogs, especially large dogs |
| [Shedding](#grooming) | Very light, good for allergy sufferers |
| [Grooming](#grooming) | A goodly amount of brushing, combing, and trimming; else clip the coat short |
| [Lifespan](#health) | 12-15 years |
| [Colors](#colors) | Blue and tan (most common), other colors are possible |
...
But certainly the different sizes can **look** different. For example, a 3-pounder looks quite delicate, compared to a sturdy 8-pounder.
...
In my [Respect Training book](https://www.yourpurebredpuppy.com/books/RTP.html) for puppies, I explain why you should always encourage calmness indoors. A dog who dashes around, jumping and barking, is keeping himself in an excitable, over-stimulated state of mind. That isn't psychologically healthy and usually leads to behavior problems.
...
All of these issues – walking on a leash, housebreaking, litter box training, stopping barking – are taught in my puppy training book, [Respect Training For Puppies](https://www.yourpurebredpuppy.com/books/RTP.html) (30 seconds to a calm, polite, well-behaved puppy).
...
- loose knee joints (luxating patella) that cause lameness and pain; Yorkshire Terriers have the 2nd highest rate of luxating patella of all breeds, with nearly 1 in 4 Yorkies affected
...
- Or check out my [training tips](https://www.yourpurebredpuppy.com/training/) to teach your Yorkshire Terrier puppy to be well-behaved.
- Also see my advice on Yorkshire Terrier [health care](https://www.yourpurebredpuppy.com/health/yorkshireterriers.html), including feeding and vaccinations
...
Finally, I wouldn't take any Yorkie, either a puppy or an adult, unless

- they had a normal *bile acids* blood test showing a normal liver with **no liver shunt**. Liver shunt is dreadfully common in Yorkies and the surgery is very expensive and doesn't always succeed. Heartbreaking to go through.
...
Yorkies are often available from [dog rescue groups](https://www.yourpurebredpuppy.com/buying/articles/dog-breed-rescue.html). Some also show up at [animal shelters](https://www.yourpurebredpuppy.com/buying/articles/animal-shelters.html), though these are usually snapped up quickly because so many prospective owners are seeking a tiny dog.
...
- [Yorkshire Terriers (Yorkies): What's Good About 'Em, What's Bad About 'Em](https://www.yourpurebredpuppy.com/reviews/yorkshireterriers.html) — capture `20230506062436`
- [Yorkshire Terriers (Yorkies): What's Good About 'Em, What's Bad About 'Em](https://www.yourpurebredpuppy.com/dog-breeds/yorkshire-terrier.html) — capture `20230506062452` — duplicate content consolidated above
- [Training Yorkshire Terriers (Yorkies)](https://www.yourpurebredpuppy.com/training/yorkshireterriers.html) — capture `20220812100131`
- [Yorkshire Terrier Health Care & Feeding](https://www.yourpurebredpuppy.com/health/yorkshireterriers.html) — capture `20230506062511`
