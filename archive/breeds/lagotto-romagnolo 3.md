...
breed_slug: "lagotto-romagnolo"
component_count: 3
unique_content_sections: 3
generated_at: "2026-08-10T13:33:02+00:00"
source_urls:
  - "https://www.yourpurebredpuppy.com/reviews/lagotto-romagnolo.html"
  - "https://www.yourpurebredpuppy.com/training/lagotto-romagnolo.html"
  - "https://www.yourpurebredpuppy.com/health/lagotto-romagnolo.html"
---
...
|  |  |
| --- | --- |
| [Temperament](#temperament) | Lively, smart, sensitive, fond of water and mud and digging, loves to run and jump and swim and fetch |
| [Pros and Cons](#pros-cons) | What's good... What's bad... |
| [Size](#size) | Mid-sized (16-19 inches, 24-35 lbs) |
| [Exercise](#exercise) | Moderate to high |
| [Training](#training) | Easy to moderate |
| [With strangers](#strangers) | Varies from friendly to aloof to a bit timid |
| [With children](#children) | Fine with well-behaved children if raised with children |
| [With other pets](#otherpets) | Usually good |
| [Shedding](#grooming) | Light |
| [Grooming](#grooming) | Moderate to significant amount |
| [Lifespan](#health) | 11-14 years |
| [Colors](#colors) | Brown, orange, white, and combos of those colors |
...
For example, the Italian Lagotto Club offers truffle-finding (working aptitude) tests throughout Italy. In the US, a variety of stimulating [activities](#exercise) can satisfy the Lagotto's craving for something challenging to do.
...
But most Lagottos learn quickly and respond beautifully to consistent leadership. This is taught in my puppy training book, [Respect Training For Puppies](https://www.yourpurebredpuppy.com/books/RTP.html) (30 seconds to a calm, polite, well-behaved puppy).
...
- Or check out my [training tips](https://www.yourpurebredpuppy.com/training/) to teach your Lagotto Romagnolo puppy to be well-behaved.
- Also see my advice on Lagotto Romagnolo [health care](https://www.yourpurebredpuppy.com/health/lagotto-romagnolo.html), including feeding and vaccinations
...
- [Lagotto Romagnolo: What's Good About 'Em, What's Bad About 'Em](https://www.yourpurebredpuppy.com/reviews/lagotto-romagnolo.html) — capture `20230506062445`
- [Training the Lagotto Romagnolo](https://www.yourpurebredpuppy.com/training/lagotto-romagnolo.html) — capture `20200929042205`
- [Lagotto Romagnolo Health Care & Feeding](https://www.yourpurebredpuppy.com/health/lagotto-romagnolo.html) — capture `20230506062509`
